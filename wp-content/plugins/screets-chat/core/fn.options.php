    ...
    <div class="wrap">
		...
		<form method="post" action="options.php" style="position: relative;">
			...
			<div class="sc_chat_info_box">
				...
				<div class="_box">(!) If you use any <strong>cache plugin</strong>, you will want to clear cache when you update options related to appearance.</div>
			</div>
...
function sc_chat_render_purchase_key( $input ) { 
	...
	<input type="text" name="sc_chat_opts[purchase_key]" value="<?php echo $opts['purchase_key']; ?>" style="width:270px"/>
