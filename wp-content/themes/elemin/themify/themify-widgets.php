...
*/
	...
	class Themify_Twitter extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			echo do_shortcode("[themify-twitter username='$username' show_count='$show_count' show_timestamp='$hide_timestamp' show_follow='$show_follow' follow_text='$follow_text' is_widget='true']");
		...
		function form( $instance ) {
			...
			/* Set up some default widget settings. */
			$defaults = array( 'title' => __('Latest Tweets', 'themify'), 'username' => '', 'show_count' => 5, 'hide_timestamp' => false, 'show_follow' => true, 'follow_text' => __('&rarr; Follow me', 'themify') );
			$instance = wp_parse_args( (array) $instance, $defaults ); ?>
